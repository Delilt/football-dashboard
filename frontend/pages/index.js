    ...
    <div className={darkMode ? "dashboard dark" : "dashboard light"}>
      ...
      <div className="content">
        ...
        <div className="charts-grid" id="charts">
          <div className="chart-card">📊 Grafik 1 (Örn: Gol Sayıları)</div>
          <div className="chart-card">📈 Grafik 2 (Örn: Takım Puanları)</div>
          <div className="chart-card">📉 Grafik 3 (Örn: Maç Sonuçları)</div>
          <div className="chart-card">📊 Grafik 4 (Örn: Lig Performansı)</div>
        </div>
        ...
        <div className="card full" id="matches">
          ...
          <div className="table-container">
            <table className="styled-table">
              <thead>
                <tr>
                  <th>Ev</th><th>Dep</th><th>Final Skor</th><th>Tarih</th><th>Lig</th>
                </tr>
              </thead>
              <tbody>
